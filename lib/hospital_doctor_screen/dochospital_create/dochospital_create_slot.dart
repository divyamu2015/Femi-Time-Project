...
String convertTo24HourNoSuffix(String time) {
  ...
  Future<void> postAvailability(bool available) async {
    final url = Uri.parse(
      "https://417sptdw-8005.inc1.devtunnels.ms/userapp/hospital-doctor/$doctorId/availability/",
    );
  ...
  Future<void> getDoctorDetails() async {
    final url = Uri.parse(
      'https://417sptdw-8005.inc1.devtunnels.ms/userapp/view_hospital_doctor/$doctorId/',
    );
