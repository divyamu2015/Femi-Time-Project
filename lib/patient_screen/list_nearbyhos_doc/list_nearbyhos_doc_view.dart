import 'package:femitime_project/patient_screen/book_now_hos_screen/book_now_view.dart';
import 'package:femitime_project/patient_screen/list_nearbyhos_doc/bloc/list_nearbyhos_bloc.dart';
import 'package:femitime_project/patient_screen/list_nearbyhos_doc/list_nearbyhos_doc_model.dart';
...
class _FindHosDoctorScreenState extends State<FindHosDoctorScreen> {
  ...
  String getAbsoluteImageUrl(String imagePath) {
    ...
    const String baseUrl =
        "https://417sptdw-8005.inc1.devtunnels.ms"; // Change this to your backend URL
