...
import 'package:femitime_project/patient_screen/feeback_hospage.dart';
...
class _BookNowHosScreenState extends State<BookNowHosScreen> {
  ...
  Future<void> fetchDoctorTimeSlots() async {
    try {
      ...
      final url = Uri.parse(
        'https://417sptdw-8005.inc1.devtunnels.ms/userapp/hospital/doctor/${widget.doctorId}/timeslots/',
      );
